...
let madeSlider = new Swiper('.catalog-made__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.catalog-made__navigation',
		prevEl: '.catalog-made__navigation .catalog-made__prev',
	},
...
let natureSlider = new Swiper('.category-nature__columns', {
	pagination: {
		el: '.category-nature__dotts',
		clickable: false,
		//dynamicBullets: true,
	...
	navigation: {
		nextEl: '.catalog-nature__navigation',
		prevEl: '.catalog-made__navigation .catalog-made__prev',
	},
	breakpoints: {
		320: {
...
da.init();
//new Swiper('.catalog-made__gallery', {
//	navigation: {
//		nextEl: '.catalog-made__next',
//		prevEl: '.catalog-made__prev',
//	},
//	pagination: {
//		el: '.catalog-made__pagination',
//		clickable: false,
//	},
//	slidesPerView: 3,
//	//loop:true,
